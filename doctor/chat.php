...
<style>
    ...
    .msg-received { align-self: flex-start; background: var(--navy-mid); border: 1px solid var(--border); }
    ...
    <header><a href="friends.php" class="back-btn">←</a><h2><?php echo htmlspecialchars($friend['name']); ?></h2></header>
