...
:root{--teal:#0EB8A0;--teal-dark:#0A8A78;--teal-glow:rgba(14,184,160,0.15);--navy:#f8fafc;--navy-mid:#ffffff;--navy-light:#f1f5f9;--navy-card:#ffffff;--white:#1e293b;--muted:#64748b;--muted-dim:#94a3b8;--success:#22C55E;--warning:#F59E0B;--danger:#EF4444;--border:rgba(0,0,0,0.08);--radius:14px;--shadow: 0 4px 20px rgba(0,0,0,0.05);}
body.dark-mode {
    --navy:       #0B1526;
    --navy-mid:   #112035;
    --navy-light: #1A3050;
