...
<aside class="sidebar">
    ...
    <div class="nav-section"><div class="nav-section-label">Monitoring</div>
        ...
        <a href="monitor_view.php" class="nav-link active"><span class="nav-icon">👥</span> Monitored Patients</a>
    </div>
</aside>
<main class="main">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    <div class="page-header"><h1>👥 Patients You Monitor</h1><p>View health and medicine checklists of patients under your care.</p></div>
    <div class="card">
    ...
    <?php else: ?>
    <div class="empty-state"><div class="empty-icon">👥</div><h3>No patients assigned</h3><p>Ask a patient to add you as their monitor using your email address.</p></div>
    <?php endif; ?>
    </div>
</main></div></body></html>
<script>
