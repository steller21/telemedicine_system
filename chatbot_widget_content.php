...
<style>
    ...
    .triage-card strong { display: block; font-size: 14px; margin-bottom: 6px; }
    .triage-note { font-size: 11px; line-height: 1.45; color: #5f6b7a; margin-bottom: 10px; }
    .triage-question { font-size: 12px; font-weight: 600; color: #1f2937; }
    .triage-result { margin-top: 4px; padding: 10px; border-radius: 12px; background: #ffffff; color: #1f2937; border: 1px solid #dbe4f0; }
    ...
    .triage-badge { display: inline-flex; align-items: center; gap: 6px; padding: 4px 10px; border-radius: 999px; font-size: 10px; font-weight: 800; letter-spacing: 0.04em; text-transform: uppercase; margin-bottom: 8px; }
...
function callEmergency(num) {
  if (confirm('Call ' + num + ' ?')) {
    window.top.location.href = 'tel:' + num;
  }
}
...
initChat = function () {
  ...
  appendBotMessage(
    ...
    'Use the symptom checker to judge urgency before booking, or type a symptom for quick first-aid tips.' +
