        ...
        <form method="POST">
            <div class="form-group">
                ...
                <div class="role-toggle">
                    <button type="button" class="role-btn <?php echo (!isset($_POST['role']) || $_POST['role'] === 'patient') ? 'active' : ''; ?>" onclick="setRole('patient', event)">Patient</button>
                    <button type="button" class="role-btn <?php echo (isset($_POST['role']) && $_POST['role'] === 'doctor') ? 'active' : ''; ?>" onclick="setRole('doctor', event)">Doctor</button>
                </div>
